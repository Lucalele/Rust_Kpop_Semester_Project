...
"#,
        ...
        .expect("Could not create company table");
...
"#,
        ...
        .expect("Could not create label table");
...
"#,
        ...
        .expect("Could not create idol table");
...
"#,
        ...
        .expect("Could not create name table");
...
"#,
        ...
        .expect("Could not create group table");
...
"#,
        ...
        .expect("Could not create subunit table");
...
"#,
        ...
        .expect("Could not create project table");
    connection
        .batch_execute(
            r#"
...
"#,
        ...
        .expect("Could not create member table");
...
"#,
        ...
        .expect("Could not create sub_mem table");
...
"#,
        ...
        .expect("Could not create group_mem table");
...
"#,
        ...
        .expect("Could not create comp_mem table");
    connection
        .batch_execute(
            r#"
...
"#,
        ...
        .expect("Could not create label_mem table");
...
"#,
        ...
        .expect("Could not create group_comp table");
    connection
        .batch_execute(
            r#"
...
"#,
        ...
        .expect("Could not create group_label table");
    connection
        .batch_execute(
            r#"
...
"#,
        ...
        .expect("Could not create project_parent table");
}
